    ...
    def generate_ai_response(self, message_text: str, message_type: str, sender_name: str) -> str:
        ...
        try:
            system_prompt = (
                ...
                "IMPORTANT: Only ask about salary, interviews, and remote work for actual JOB OFFERS or RECRUITMENT messages. "
                "For sales pitches, marketing messages, or non-job content, politely decline and mention you're focused on DevOps opportunities. "
                "For job offers: Ask about expected salary/salary range, number of planned interviews, and if fully remote work is possible. "
